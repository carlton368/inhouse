...
def build(source_path, build_path, install_path, targets):
    ...
    # libIlmImf 소스코드 다운로드 (.tar.gz 사용)
    libilmimf_url = "https://github.com/AcademySoftwareFoundation/openexr/archive/refs/tags/v2.4.3.tar.gz"  # 예시 URL
    archive_name = "openexr-2.4.3.tar.gz"
    archive_path = download_source(source_path, libilmimf_url, archive_name)

    # 체크섬 검증
    expected_checksum = "017367529a21196905bcabc6f046f3033363d90115395196b9c1abd0ad80606a"  # 실제 체크섬으로 교체
    ...
    # 추출된 소스 디렉토리 경로
    libilmimf_source_dir = os.path.join(build_path, "openexr-2.4.3", "IlmImf")
